...
from attention.main import main as m

flags = tf.app.flags

flags.DEFINE_string("model_name", "attention", "Model name [attention]")
flags.DEFINE_string("data_dir", "data/squad_full", "Data dir [data/squad_full]")
