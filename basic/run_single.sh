...
python3 -m squad.prepro --mode dev -s /Applications/MAMP/htdocs/bi-att-flow/data/squad/ $parg --target_dir $inter_dir --glove_dir .
...
#python3 -m basic.cli --data_dir $inter_dir --eval_path $eval_path --nodump_answer --load_path $load_path --shared_path $shared_path $marg --eval_num_batches 0 --mode forward --batch_size 60 --len_opt --cluster --cpu_opt --load_ema
...
python3 -m basic.ensemble --data_path $inter_dir/data_dev.json --shared_path $inter_dir/shared_dev.json -o $target_path $eval_path
