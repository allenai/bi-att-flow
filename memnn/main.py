...
from memnn.evaluator import DoubleAccuracyEvaluator, Evaluator
from memnn.graph_handler import GraphHandler
from memnn.model import Model
from memnn.trainer import Trainer

from memnn.read_data import load_metadata, read_data, get_squad_data_filter, update_config
...
def _train(config):
    ...
    evaluator = DoubleAccuracyEvaluator(config, model)
